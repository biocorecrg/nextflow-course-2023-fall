...
To do so you can add this string of code to your **.bashrc**, which is a file that is run every time you log in to a remote computer in the HPC or you submit a job:
