...
During the execution, Nextflow creates a number of temporary folders and a soft link to the original input file. It will then store output files locally.
